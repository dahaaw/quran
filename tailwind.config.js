...
module.exports = {
  ...
  theme: {
    ...
    extend: {
      fontFamily:{ 
        sans: ['Patrick Hand', 'Arial', 'san-serif']
      }
    },
  },
  variants: {
